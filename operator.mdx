...
## Release Notes
### [release-1683920897](https://github.com/massdriver-cloud/azure-storage-account-application-assets/releases/tag/release-1683920897)
## What's Changed
* Update storage module ref by @mclacore in https://github.com/massdriver-cloud/azure-storage-account-application-assets/pull/25


**Full Changelog**: https://github.com/massdriver-cloud/azure-storage-account-application-assets/compare/release-1680798810...release-1683920897
### [release-1680798810](https://github.com/massdriver-cloud/azure-storage-account-application-assets/releases/tag/release-1680798810)
## What's Changed
* Removed VNet integration by @mclacore in https://github.com/massdriver-cloud/azure-storage-account-application-assets/pull/24


**Full Changelog**: https://github.com/massdriver-cloud/azure-storage-account-application-assets/compare/release-1680563786...release-1680798810
